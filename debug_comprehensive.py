...
# Mock functions to simulate service returns
def mock_liquidity():
    return {"drought_probability": 0.5, "risk_level": "LOW"}

def mock_flow():
    return {"divergence": {"divergence_detected": False}}

def mock_options():
    # Simulate the potentially problematic structure
    return {
        "danger_zones": [{"level": 100.0, "type": "psychological"}],
        "max_pain_estimate": {"estimated_level": 100.0}
    }
